  ...
  const saveFeature = async (index: number) => {
    ...
    try {
      const { error } = await supabase
        ...
        .upsert({
          id: feature.id,
          settings_id: feature.settings_id,
      ...
      <CardContent className="space-y-4">
        {editingFeatures.length === 0 ? (
          ...
          <>
                    ...
                    <div className="flex-1 space-y-3">
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <Select value={feature.icon_name} onValueChange={(v) => updateFeature(index, 'icon_name', v)}>
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          placeholder="Izin Resmi Kemenag"
                        />
                      </div>
                      <div>
                        ...
                        <Textarea
                          ...
                          placeholder="Terdaftar dan berizin resmi..."
                          rows={2}
                        />
                      </div>
            ...
            <Button onClick={addFeature} variant="outline" className="w-full mt-4">
              <Plus className="h-4 w-4 mr-2" />
              Tambah Fitur
            </Button>
          </>
