...
export function GallerySection({ settings }: GallerySectionProps) {
  ...
  const { data: galleryItems = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      return data || fallbackGalleryItems;
    },
  });
...
// Fallback gallery items (Phase 2 placeholder data)
const fallbackGalleryItems: GalleryItem[] = [
  {
    id: '1',
    title: 'Jamaah di Masjidil Haram',
    description: 'Pengalaman spiritual yang tak terlupakan di hadapan Kaabah dengan ribuan jamaah lainnya',
  ...
  {
    id: '2',
    title: 'Tawaf Berjamaah',
    description: 'Momen indah saat melakukan tawaf bersama-sama dalam suasana khusyuk',
    image_url: 'https://images.unsplash.com/photo-1564507592333-c60657eea523?q=80&w=2070',
    type: 'image',
    category: 'umroh',
    order: 2,
  },
  {
    id: '3',
    title: 'Bukit Safa dan Marwa',
    description: 'Melaksanakan sa\'i di antara Bukit Safa dan Marwa dengan penuh khusyuk',
  ...
  },
  {
    id: '4',
    title: 'Kota Madinah',
    description: 'Kunjungan ke Masjid Nabawi dan kota suci Madinah',
    image_url: 'https://images.unsplash.com/photo-1518684029980-cf91ee70ee05?q=80&w=2070',
    type: 'image',
    category: 'umroh',
    order: 4,
  },
  {
    ...
    description: 'Wukuf di Padang Arafah - puncak ibadah haji yang penuh makna',
    image_url: 'https://images.unsplash.com/photo-1511379938547-c1f69b13d835?q=80&w=2070',
    type: 'image',
    category: 'haji',
    order: 5,
  },
  {
    id: '6',
    title: 'Penyambutan Jamaah',
    description: 'Momen penuh kebahagiaan saat jamaah tiba di bandara dengan selamat',
