  ...
  return (
    <TooltipProvider>
      <Tabs defaultValue="permissions" className="w-full h-full flex flex-col">
        ...
        <TabsContent value="permissions" className="space-y-3 outline-none flex-1 flex flex-col min-h-0">
          {/* Stats - Sticky at top */}
                        ...
                        {items.map((perm) => (
                          <div
                            ...
                            className={cn(
                              ...
                              perm.is_enabled ? "bg-white hover:bg-gray-50" : "bg-red-50/30 hover:bg-red-50/50"
                            )}
                          >
        ...
        <TabsContent value="audit" className="outline-none flex-1 flex flex-col min-h-0">
          <ScrollArea className="flex-1 pr-4 -mr-4">
            <div className="pr-4">
              {auditLoading ? (
