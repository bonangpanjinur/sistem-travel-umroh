...
-- FILE 010: Views
-- Run AFTER 009. Setiap CREATE OR REPLACE VIEW dibungkus DO + EXECUTE.
-- Jika tabel/kolom belum ada (tabel dari migrasi lama), view di-skip
...
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_bookings_full: %', SQLERRM;
END;
$wrap$;
...
BEGIN
  ...
  $view$;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_departures_with_stats: %', SQLERRM;
END;
$wrap$;
...
BEGIN
  ...
  $view$;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_customers_summary: %', SQLERRM;
END;
$wrap$;
...
BEGIN
  ...
  $view$;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_departure_pl: %', SQLERRM;
END;
$wrap$;
...
BEGIN
  ...
  $view$;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_payments_pending: %', SQLERRM;
END;
$wrap$;
...
BEGIN
  ...
  $view$;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_agents_performance: %', SQLERRM;
END;
$wrap$;
...
BEGIN
  ...
  $view$;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_wa_send_logs_full: %', SQLERRM;
END;
$wrap$;
...
BEGIN
  ...
  $view$;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_inventory_alerts: %', SQLERRM;
END;
$wrap$;
...
BEGIN
  ...
  $view$;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'SKIP v_upcoming_departures: %', SQLERRM;
END;
$wrap$;
