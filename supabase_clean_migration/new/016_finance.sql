...
CREATE INDEX IF NOT EXISTS idx_dep_cost_items_departure
  ON public.departure_cost_items(departure_id);
...
CREATE INDEX IF NOT EXISTS idx_ar_reminder_booking
  ON public.ar_reminder_log(booking_id);
