-- Defensive re-apply: ensure update_booking_paid_amount NEVER touches generated remaining_amount
...
BEGIN
  ...
  -- Explicit columns only; NEVER include generated remaining_amount
