...
const STATIC_ROADMAP: RoadmapItem[] = [
  ...
  { id: "7",  phase: 2, code: "WA_MULTIPROVIDER",     title: "Multi-Provider (Fonnte/Wablas/…)", description: "Support banyak gateway WA, dipilih dari panel admin", status: "done",        target_date: null, sort_order: 70 },
  { id: "8",  phase: 2, code: "WA_ADMIN_KEY_PANEL",   title: "Panel Kelola API Key di Admin",    description: "Super admin/owner/IT simpan & ganti key dari UI", status: "done",         target_date: null, sort_order: 80 },
  { id: "9",  phase: 2, code: "WA_AUTO_REMINDER",     title: "Auto-Jadwal Reminder Pembayaran",  description: "Buat baris reminder H-7/H-3 otomatis", status: "done",                   target_date: null, sort_order: 90 },
  { id: "10", phase: 3, code: "WA_BROADCAST_SEGMENT", title: "Broadcast Tersegmentasi",          description: "Filter: by paket, keberangkatan, status bayar", status: "done",          target_date: null, sort_order: 100 },
  { id: "11", phase: 3, code: "WA_CAMPAIGN_MANAGER",  title: "Manajemen Kampanye Broadcast",     description: "Jadwal pengiriman, riwayat kampanye, statistik", status: "done",         target_date: null, sort_order: 110 },
  { id: "12", phase: 3, code: "WA_DELIVERY_RECEIPT",  title: "Status Terkirim & Dibaca",         description: "Webhook status delivered/read dari provider", status: "done",             target_date: null, sort_order: 120 },
  { id: "13", phase: 4, code: "WA_CHATBOT_KEYWORD",   title: "Auto-Reply Berbasis Kata Kunci",   description: "Balas otomatis jika jamaah kirim kata kunci", status: "in_progress",      target_date: null, sort_order: 130 },
  { id: "14", phase: 4, code: "WA_CHATBOT_MENU",      title: "Bot Menu Interaktif",              description: "Menu nomor (1. Cek booking, 2. Hubungi CS…)", status: "in_progress",      target_date: null, sort_order: 140 },
  { id: "15", phase: 4, code: "WA_INBOX",             title: "Inbox WA di Admin Panel",          description: "Lihat & balas pesan masuk dari admin panel", status: "in_progress",      target_date: null, sort_order: 150 },
  { id: "16", phase: 5, code: "WA_META_CLOUD",        title: "WhatsApp Cloud API (Meta/WABA)",   description: "Integrasi resmi Meta Business API", status: "done",                      target_date: null, sort_order: 160 },
  { id: "17", phase: 5, code: "WA_CONTACT_MGMT",      title: "Manajemen Kontak WA",              description: "Sinkronisasi kontak jamaah ke daftar provider", status: "in_progress",  target_date: null, sort_order: 170 },
