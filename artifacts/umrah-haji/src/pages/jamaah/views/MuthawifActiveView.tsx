...
import {
  ...
  MapPin, ChevronRight, Phone, Calendar,
} from "lucide-react";
...
export function MuthawifActiveView({ ctx }: Props) {
  ...
  // Fetch SOS alerts for this departure
  ...
  // Fetch today's sessions for quick attendance status
    ...
    <JamaahAppShell>
      ...
      <div className="px-4 py-4 space-y-4 pb-32">
        ...
        <div className="rounded-2xl border bg-card p-4 space-y-2">
          <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Info Keberangkatan</p>
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div>
              ...
              <p className="font-semibold text-[12px]">
                {dep.departure_date ? format(new Date(dep.departure_date), "d MMM yyyy", { locale: id }) : "–"}
              </p>
            </div>
          </div>
        </div>
