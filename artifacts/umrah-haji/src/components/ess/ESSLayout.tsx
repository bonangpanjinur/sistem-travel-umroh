...
import {
  LayoutDashboard, FileText, CalendarOff, TrendingUp, User, LogOut, Menu, X, Building2, ClipboardCheck, GraduationCap
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/ess/training",   label: "Training Saya", icon: GraduationCap },
