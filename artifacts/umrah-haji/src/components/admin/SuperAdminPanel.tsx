...
const SHORTCUT_SECTIONS: { title: string; shortcuts: Shortcut[] }[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { label: 'Jurnal Umum',     path: '/admin/finance/jurnal',             icon: FileText,   color: 'bg-emerald-100 text-emerald-600' },
      { label: 'Buku Besar',      path: '/admin/finance/buku-besar',         icon: BarChart3,  color: 'bg-teal-100 text-teal-600' },
      { label: 'Neraca Saldo',    path: '/admin/finance/neraca-saldo',       icon: TrendingUp, color: 'bg-cyan-100 text-cyan-600' },
      { label: 'Laba Rugi',       path: '/admin/finance/laba-rugi',          icon: TrendingUp, color: 'bg-rose-100 text-rose-600' },
      { label: 'Neraca',          path: '/admin/finance/neraca',             icon: BarChart3,  color: 'bg-indigo-100 text-indigo-600' },
      { label: 'Arus Kas',        path: '/admin/finance/arus-kas',           icon: Coins,      color: 'bg-blue-100 text-blue-600' },
