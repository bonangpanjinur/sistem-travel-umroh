...
export const RECOMMENDED_MENUS: AdminMenuItem[] = [
  ...
  { key: 'payment-verification', label: 'Verifikasi Transfer',  path: '/admin/payment-verification', icon: 'ShieldCheck',     group_name: 'Keuangan',           sort_order: 503, required_permission: PERMISSIONS.PAYMENT_VERIFICATION },
  { key: 'bank-accounts',       label: 'Rekening Bank',         path: '/admin/bank-accounts',        icon: 'Landmark',        group_name: 'Keuangan',           sort_order: 504, required_permission: PERMISSIONS.BANK_ACCOUNTS },
  { key: 'refunds',             label: 'Monitor Refund',        path: '/admin/refunds',              icon: 'RotateCcw',       group_name: 'Keuangan',           sort_order: 505, required_permission: PERMISSIONS.REFUNDS },
  { key: 'finance-cash',        label: 'Kas & Bank',            path: '/admin/finance-cash',         icon: 'Coins',           group_name: 'Keuangan',           sort_order: 506, required_permission: PERMISSIONS.FINANCE_CASH },
  { key: 'finance-ar',          label: 'Piutang (AR)',          path: '/admin/finance/ar',           icon: 'ArrowDownToLine', group_name: 'Keuangan',           sort_order: 507, required_permission: PERMISSIONS.FINANCE_AR },
  { key: 'finance-ap',          label: 'Hutang (AP)',           path: '/admin/finance/ap',           icon: 'ArrowUpFromLine', group_name: 'Keuangan',           sort_order: 508, required_permission: PERMISSIONS.FINANCE_AP },
  ...
  { key: 'aturan-pembatalan',       label: 'Aturan Pembatalan',     path: '/admin/aturan-pembatalan',       icon: 'ClipboardList', group_name: 'Dokumen & Legalitas', sort_order: 809, required_permission: PERMISSIONS.CANCELLATION_POLICIES },
  ...
  { key: 'hr-training',        label: 'Kurikulum Onboarding',  path: '/admin/hr/training',          icon: 'BookOpen',       group_name: 'SDM',                sort_order: 704, required_permission: PERMISSIONS.TRAINING },
  { key: 'training-notif',    label: 'Notifikasi Training',   path: '/admin/hr/training-notif',    icon: 'Bell',           group_name: 'SDM',                sort_order: 708, required_permission: PERMISSIONS.TRAINING },
  { key: 'sdm-laporan',       label: 'Laporan SDM',           path: '/admin/hr/laporan',           icon: 'FileText',       group_name: 'SDM',                sort_order: 709, required_permission: PERMISSIONS.HR },
  ...
  { key: 'hr-onboarding',     label: 'Onboarding Karyawan',   path: '/admin/hr/onboarding',        icon: 'ClipboardList',   group_name: 'SDM',                sort_order: 707, required_permission: PERMISSIONS.HR },
...
export const ROLE_DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ...
  branch_manager: [
    ...
    'payments', 'payment-verification', 'bank-accounts', 'reports', 'reports-central',
  ...
  finance: [
    ...
    'bookings', 'payments', 'payment-verification', 'bank-accounts', 'refunds', 'finance-cash', 'finance-ar', 'finance-ap',
  ...
  marketing: [
    ...
    'wa-broadcast', 'wa-chatbot', 'wa-inbox', 'wa-contacts', 'wa-bot-menu', 'wa-template-broadcast',
