...
export const RECOMMENDED_MENUS: AdminMenuItem[] = [
  ...
  { key: 'chat-logs',          label: 'Log Percakapan',         path: '/admin/chat-logs',          icon: 'ScrollText',        group_name: 'AI & Analytics',      sort_order: 562, required_permission: PERMISSIONS.GEMINI_AI },
